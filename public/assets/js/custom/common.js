...
$('#create-form,.create-form,.create-form-without-reset').on('submit', function (e) {
    ...
    if (formElement.data('is-submitting')) {
        return false;
    }
    formElement.data('is-submitting', true);
    setTimeout(() => {
        formElement.data('is-submitting', false);
    }, 2000); // Prevent global double-submits within 2 seconds
