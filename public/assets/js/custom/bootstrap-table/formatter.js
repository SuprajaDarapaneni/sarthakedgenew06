...
/**
 * Format a number as Indian Rupees (₹) with en-IN locale grouping.
 */
...
/**
 * Render a components count badge for fee types.
 */
function componentsCountFormatter(value) {
    if (!value || value === 0) {
        return '<span class="badge badge-light text-muted">—</span>';
    }
    return '<span class="badge badge-info">' + value + ' component' + (value > 1 ? 's' : '') + '</span>';
}
