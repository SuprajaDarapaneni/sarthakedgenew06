...
class PackageController extends Controller
{
    ...
    public function index()
    {
        ...
        $packages = $this->package->builder()->with('package_feature.feature')
            ->orderBy('rank', 'ASC')
            ->get();
    ...
    public function features_list()
    {
        ...
        $features = Feature::activeFeatures()->orderBy('name', 'ASC')->get();
        foreach ($features as $feature) {
            $feature->permission = $this->features_permission($feature->name);
        }
    ...
    public function feature_store(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            ResponseService::logErrorResponse($e, 'Feature Controller -> Store method');
            ResponseService::errorResponse();
        }
    }
    ...
    public function feature_update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            ResponseService::logErrorResponse($e, 'Feature Controller -> Update method');
            ResponseService::errorResponse();
        }
    }
    ...
    {
        ResponseService::noAnyPermissionThenSendJson(['package-delete']);
        try {
            DB::beginTransaction();
            ...
            DB::rollBack();
            ResponseService::logErrorResponse($e, 'Feature Controller -> Destroy method');
            ResponseService::errorResponse();
        }
    }
    ...
    public function feature_status($id)
    {
        ...
        try {
            ...
            DB::rollBack();
            ResponseService::logErrorResponse($e, 'Feature Controller -> change status method');
            ResponseService::errorResponse();
        }
    }
}
