...
class MediumController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            \Illuminate\Support\Facades\Log::info('Medium Create request payload: ' . json_encode($request->all()));
            \Illuminate\Support\Facades\Log::info('Medium Create Auth user: ' . (\Auth::user() ? json_encode(\Auth::user()->toArray()) : 'NULL'));
