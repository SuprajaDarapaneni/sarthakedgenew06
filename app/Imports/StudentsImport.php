...
class FirstSheetImport implements ToCollection, WithHeadingRow
{
    ...
    public function collection(Collection $collection)
    {
        ...
        $validator = Validator::make($collection->toArray(), [
            ...
            '*.guardian_gender'=> ['required', new TrimmedEnum(['male', 'female', 'Male', 'Female'])],
            '*.dob'            => 'required|date',
            ...
            '*.gender.in' => 'Gender must be either Male or Female only.',
            '*.guardian_gender.required' => 'Please select the gender.',
            '*.guardian_gender.in' => 'Guardian gender must be either Male or Female only.',
