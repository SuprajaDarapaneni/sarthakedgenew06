...
class PaymentTransaction extends Model {
    ...
    {
        // For web requests: use session-based connection name
        // For API requests: session is null, so fall back to the runtime default connection
        // which is set correctly by APISwitchDatabase middleware via DB::setDefaultConnection()
        return session('db_connection_name') ?? \Illuminate\Support\Facades\DB::getDefaultConnection();
    }
