...
<script>
    ...
    if (nav_logo == null || nav_logo == '') {
        nav_logo = "{{ $systemSettings['horizontal_logo'] ?? asset('assets/web-site-images/logo.png') }}";
    }
    ...
    // Favicon
    $('.school-favicon').attr('href', "{{ $schoolSettings['favicon'] ?? $systemSettings['favicon'] ?? asset('assets/web-site-images/favicon.png') }}");
