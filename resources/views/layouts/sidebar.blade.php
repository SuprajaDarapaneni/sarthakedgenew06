...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
                            ...
                            @can('timetable-list')
                                <li class="nav-item">
                                    <a href="{{ route('timetable.teacher.index') }}" class="nav-link"
                                        data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Timetable Management')">
            ...
            <li class="nav-item">
                @can('holiday-list')
                    <a href="{{ route('holiday.index') }}" class="nav-link"
                        data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Holiday Management')">
                        ...
                        @canany(['lesson-list', 'lesson-create', 'lesson-edit', 'lesson-delete'])
                            <li class="nav-item">
                                <a href="{{ url('lesson') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Lesson Management')">
                                    {{ __('create_lesson') }}</a>
                            </li>
                        @endcanany
                        ...
                        @can('assignment-create')
                            <li class="nav-item">
                                <a href="{{ route('assignment.index') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Assignment Management')">
        ...
        @can('slider-create')
            <li class="nav-item">
                <a href="{{ route('sliders.index') }}" class="nav-link"
                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Slider Management')">
        ...
        @canany(['notification-create', 'notification-list', 'notification-delete'])
            <li class="nav-item">
                <a href="{{ route('notifications.index') }}" class="nav-link"
                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Announcement Management')">
                        ...
                        @canany(['class-teacher', 'attendance-create'])
                            <li class="nav-item">
                                <a href="{{ route('attendance.index') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Attendance Management')">
                                    {{ __('add_attendance') }}
                                </a>
                            </li>
                        @endcan
        ...
        @if (!Auth::user()->hasRole('School Admin') && Auth::user()->school_id)
            <li class="nav-item">
                <a href="{{ route('staff-attendance.your-index') }}" class="nav-link"
                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Staff Attendance Management')">
                    <i class="fa fa-calendar-check-o menu-icon"></i>
        ...
        @canany(['exam-create', 'exam-upload-marks', 'grade-create', 'exam-result', 'view-exam-marks', 'online-exam-create', 'online-exam-list', 'online-exam-edit', 'online-exam-delete'])
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#examinations-menu" aria-expanded="false"
                    aria-controls="examinations-menu" data-access="@hasFeatureAccess('Exam Management')">
                    <i class="fa fa-book menu-icon"></i>
                    <span class="menu-title">{{ __('Examinations') }}</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="examinations-menu">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('exams.index') }}" class="nav-link" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Exam List') }}
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('exams.timetable') }}" class="nav-link" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Exam Timetable') }}
                            </a>
                        </li>
                        @can('exam-upload-marks')
                        <li class="nav-item">
                            <a href="{{ route('exams.upload-marks') }}" class="nav-link" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Marks Entry') }}
                            </a>
                        </li>
                        @endcan
                        @can('exam-result')
                        <li class="nav-item">
                            <a href="{{ route('exams.get-result') }}" class="nav-link" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Results/Report Cards') }}
                            </a>
                        </li>
                        @endcan
                        @can('grade-create')
                        <li class="nav-item">
                            <a href="{{ route('exam.grade.index') }}" class="nav-link" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Grade System') }}
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="nav-item">
                            <a href="{{ route('online-exam-question.index') }}" class="nav-link" data-access="@hasFeatureAccess('Exam Management')">
                                {{ __('Question Bank') }}
                            </a>
                        </li>
                        @endcan
                    ...
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('leave.index') }}" class="nav-link"
                                data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Staff Leave Management')">
                                {{ __('apply_leave') }}
                            </a>
                        </li>
        ...
        @if (Auth::user()->school_id && Auth::user()->staff)
            <li class="nav-item">
                <a href="{{ route('payroll.slip.index') }}" class="nav-link"
                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Expense Management')">
        ...
        @canany(['gallery-create', 'gallery-list', 'gallery-edit', 'gallery-delete'])
            <li class="nav-item">
                <a href="{{ route('gallery.index') }}" class="nav-link"
                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('School Gallery Management')">
                        ...
                        @canany(['certificate-create', 'certificate-list', 'certificate-edit', 'certificate-delete'])
                            <li class="nav-item">
                                <a href="{{ url('certificate-template') }}" class="nav-link"
                                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="settings-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('fees-config')
                            <li class="nav-item">
                                <a href="{{ route('fees.config.index') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Fees Management')">
                                    {{ __('Fees Settings') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('school-setting-manage')
                            <li class="nav-item">
                                <a href="{{ route('school-settings.online-exam.index') }}" class="nav-link text-wrap"
                                    data-name="{{ Auth::user()->getRoleNames()->first() ?? '' }}" data-access="@hasFeatureAccess('Exam Management')">
