            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="pt-3 create-staff-form" id="create-form" action="{{ route('staff.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="number" name="mobile" id="mobile" min="0" pattern="[0-9]{6,15}"
                                        ...
                                        placeholder="{{__('contact')}}" class="form-control remove-number-increment"
                                        required>
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="text" name="dob" class="datepicker-popup-no-future form-control"
                                        placeholder="{{ __('dob') }}" required autocomplete="off">
                                ...
                                @if (!$user->school_id)
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <select name="school_id[]" id="assign_schools"
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="text" name="joining_date" class="datepicker-popup form-control"
                                        placeholder="{{ __('joining_date') }}" autocomplete="off">
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                ...
                                @if(count($extraFields))
                                    ...
                                    @foreach ($extraFields as $key => $data)
                                        <div class="form-group col-sm-12 col-md-4">
                                            ...
                                            <input type="hidden" name="extra_fields[{{ $key }}][id]"
                                                id="{{ $data->type . '_' . $key . '_id' }}" value="">

                                            {{-- Form Field ID --}}
                                            <input type="hidden" name="extra_fields[{{ $key }}][form_field_id]"
                                                id="{{ $data->type . '_' . $key . '_id' }}" value="{{ $data->id }}">
                                            ...
                                            @if($data->type == 'text')
                                                <input type="text" name="extra_fields[{{ $key }}][data]"
                                                    class="form-control text-fields" id="{{ $data->type . '_' . $key }}"
                                                    placeholder="{{ $data->name }}" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                {{-- Number Field --}}
                                            @elseif($data->type == 'number')
                                                <input type="number" name="extra_fields[{{ $key }}][data]"
                                                    class="form-control number-fields" id="{{ $data->type . '_' . $key }}"
                                                    placeholder="{{ $data->name }}" min="0" {{ $data->is_required == 1 ? 'required' : '' }}>

                                                {{-- Dropdown Field --}}
                                            @elseif($data->type == 'dropdown')
                                                <select name="extra_fields[{{ $key }}][data]" id="{{ $data->type . '_' . $key }}"
                                                            ...
                                                            <div class="form-check mr-2">
                                                                <label class="form-check-label">
                                                                    <input type="radio" name="extra_fields[{{ $key }}][data]"
                                                                        value="{{ $value }}" class="radio-fields"
                                                                        id="{{ $data->type . '_' . $keyRadio }}" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                                    {{$value}}
                                                                </label>
                                                            </div>
                                                        @endforeach
                                                            ...
                                                            <div class="mr-2 form-check">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" name="extra_fields[{{ $key }}][data][]"
                                                                        value="{{ $value }}" class="form-check-input chkclass checkbox-fields"
                                                                        id="{{ $data->type . '_' . $chkKey }}" {{ $data->is_required == 1 ? 'required' : '' }}> {{ $value }}
                                            ...
                                            @elseif($data->type == 'textarea')
                                                <textarea name="extra_fields[{{ $key }}][data]" id="{{ $data->type . '_' . $key }}"
                                                    class="form-control textarea-fields" placeholder="{{ $data->name }}" rows="3" {{ $data->is_required ? 'required' : '' }}></textarea>

                                                {{-- File Upload Field --}}
                                            @elseif($data->type == 'file')
                                                <div class="input-group col-xs-12">
                                                    <input type="file" name="extra_fields[{{ $key }}][data]" class="file-upload-default"
                                                        id="{{ $data->type . '_' . $key }}" {{ $data->is_required ? 'required' : '' }}>
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h4 class="mb-0">{{ __('allowances') }}</h4>
                                        <a href="{{ route('payroll-setting.index') }}" target="_blank"
                                                ...
                                                <div class="form-group col-xl-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button type="button" class="btn btn-sm btn-inverse-primary create-payroll-setting" data-type="allowance">
                                            ...
                                            <div class="row deduction_type_div" id="deduction_type_div" data-repeater-item>
                                                <div class="form-group col-xl-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button type="button" class="btn btn-sm btn-inverse-primary create-payroll-setting" data-type="deduction">
                                                                <i class="fa fa-plus"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @endif
                                    <th scope="col" data-field="staff.session_year.name" data-visible="false">
                                        {{ __('join_session_year') }}</th>
                                    <th scope="col" data-field="staff.session_year.name" data-visible="false">
                                        {{ __('leave_session_year') }}</th>
                                    @if (!$user->school_id)
                                    ...
                                    <th scope="col" data-field="updated_at" data-sortable="true" data-visible="false">
                                        {{ __('updated_at') }}</th>
                                    <th scope="col" data-field="operate" data-events="staffEvents" data-escape="false">
                                        {{ __('action') }}</th>
                                </tr>
                            </thead>
                        </table>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <form class="pt-3 edit-staff-form" id="edit-form" action="{{ url('staff') }}"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <input type="email" name="email" id="edit_email" placeholder="{{__('email')}}"
                                            class="form-control" required>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label>{{ __('image') }} <span
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <input type="text" name="dob"
                                            class="datepicker-popup-no-future form-control edit-dob"
                                            placeholder="{{ __('dob') }}" required autocomplete="off">
                                        <span class="input-group-addon input-group-append">
                                        </span>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <input type="text" name="joining_date" id="edit_joining_date" class="datepicker-popup form-control" placeholder="{{ __('joining_date') }}" autocomplete="off">
                                            ...
                                            @if (!$user->school_id)
                                                <div class="form-group col-sm-12 col-md-4">
                                                    <label for="assign_schools">{{__('assign') }} {{ __('schools') }}</label>
                                                    <select name="school_id[]" id="edit_school_id" class="form-control select2-dropdown select2-hidden-accessible" multiple>
                                                        @foreach($schools as $id => $name)
                                                            <option value="{{ $id }}">{{ $name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            @if(!empty($extraFields) && $user->school_id)
                                                {{-- Loop the FormData --}}
                                                <div class="row other-details">
                                                    ...
                                                    @foreach ($extraFields as $key => $data)
                                                        ...
                                                        {{-- Edit Extra Details ID --}}
                                                        <input type="hidden" name="edit_extra_fields[{{ $key }}][id]" class="edit_extra_fields_id" id="edit_{{ $fieldName }}_id" value="">

                                                        {{-- Form Field ID --}}
                                                        <input type="hidden" name="edit_extra_fields[{{ $key }}][form_field_id]" value="{{ $data->id }}">
                                                        ...
                                                        <div class='form-group col-md-12 col-lg-6 col-xl-4 col-sm-12'>
                                                            ...
                                                            {{-- Text Field --}}
                                                            @if($data->type == 'text')
                                                                <input type="text" name="edit_extra_fields[{{ $key }}][data]" class="form-control text-fields" id="edit_{{ $fieldName }}" placeholder="{{ $data->name }}" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                                {{-- Number Field --}}
                                                            @elseif($data->type == 'number')
                                                                <input type="number" name="edit_extra_fields[{{ $key }}][data]" class="form-control number-fields" id="edit_{{ $fieldName }}" placeholder="{{ $data->name }}" min="0" {{ $data->is_required == 1 ? 'required' : '' }}>

                                                                {{-- Dropdown Field --}}
                                                            @elseif($data->type == 'dropdown')
                                                                <select name="edit_extra_fields[{{ $key }}][data]" id="edit_{{ $fieldName }}" class="form-control select-fields" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                                    <option value="">{{ __('Select') . ' ' . $data->name }}</option>
                                                                    @foreach($data->default_values as $option)
                                                                        <option value="{{ $option }}">{{ $option }}</option>
                                                                    @endforeach
                                                                ...
                                                                <div class="row form-check-inline ml-1">
                                                                    @foreach ($data->default_values as $keyRadio => $value)
                                                                        <div class="col-md-12 col-lg-12 col-xl-6 col-sm-12 form-check">
                                                                            <label class="form-check-label">
                                                                                <input type="radio" name="edit_extra_fields[{{ $key }}][data]" value="{{ $value }}" class="edit-radio-fields" id="edit_{{ $fieldName . '_' . $keyRadio }}" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                                                {{$value}}
                                                                            </label>
                                                                        </div>
                                                                    @endforeach
                                                            ...
                                                            @elseif($data->type == 'checkbox')
                                                                ...
                                                                <div class="row form-check-inline ml-1">
                                                                    @foreach ($data->default_values as $chkKey => $value)
                                                                        <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12 form-check">
                                                                            <label class="form-check-label">
                                                                                <input type="checkbox" name="edit_extra_fields[{{ $key }}][data][]" value="{{ $value }}" class="form-check-input chkclass checkbox-fields" id="edit_{{ $fieldName . '_' . $chkKey }}" {{ $data->is_required == 1 ? 'required' : '' }}> {{ $value }}
                                                                            </label>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                                ...
                                                                {{-- Textarea Field --}}
                                                            @elseif($data->type == 'textarea')
                                                                <textarea name="edit_extra_fields[{{ $key }}][data]" id="edit_{{ $fieldName }}" class="form-control textarea-fields" placeholder="{{ $data->name }}" rows="3" {{ $data->is_required ? 'required' : '' }}></textarea>

                                                                {{-- File Upload Field --}}
                                                            @elseif($data->type == 'file')
                                                                <div class="input-group col-xs-12">
                                                                    <input type="file" name="edit_extra_fields[{{ $key }}][data]" class="file-upload-default" id="edit_{{ $fieldName }}" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                                    <input type="text" class="form-control file-upload-info" disabled placeholder="{{ __('image') }}">
                                                                    <span class="input-group-append">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $(document).on('click', '.create-payroll-setting', function() {
