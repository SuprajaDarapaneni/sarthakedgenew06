        ...
        function renderAttendanceData(data, month, year) {
            ...
            if (data.success && data.attendance && data.attendance.length >= 0) {
                ...
                if (data.summary) {
                    ...
                    const overviewPercentage = document.getElementById('overview_attendance_percentage');
                    const overviewPresent = document.getElementById('overview_attendance_present');
                    const overviewTotal = document.getElementById('overview_attendance_total');
                    
                    if (overviewPercentage) overviewPercentage.innerText = `${data.summary.attendance_percentage || 0}%`;
                    if (overviewPresent) overviewPresent.innerText = data.summary.present_count || 0;
                    if (overviewTotal) overviewTotal.innerText = data.summary.total_days || 0;
                }
