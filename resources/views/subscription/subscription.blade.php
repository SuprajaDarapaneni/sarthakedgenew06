                        ...
                        <div class="modal-body">
                            <div class="card">
                                ...
                                <div class="modal-footer">
                                    ...
                                    @elseif ($paymentConfiguration && strtolower($paymentConfiguration->payment_method) == 'ccavenue')
                                        <form action="{{ route('subscriptions.store') }}" method="post">
                                            ...
                                            <input type="hidden" name="package_type" class="package_type" value="bill">
                                            <input type="hidden" name="subscription_id" class="subscription_id" value="">
                                            <button class="btn btn-theme payment-status" type="submit">{{ __('Pay_with_CCAvenue') }}</button>
                                        </form>
                                    @endif
...
<script>
    var system_date_format = "{{ data_get($school_settings ?? null, 'date_format') ?? data_get($school_settings ?? null, 'system_settings.date_format') ?? data_get($system_settings ?? null, 'date_format') ?? 'd-m-Y' }}";
