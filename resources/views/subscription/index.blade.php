                        ...
                        <div class="row pricing-table mt-4">
                            @foreach ($packages as $package)
                                <div class="col-md-6 col-xl-4 grid-margin stretch-card pricing-card">
                                    <div class="card @if ($package->highlight) border-success @else border-primary @endif  border pricing-card-body">
                                        ...
                                        @if (!$upcoming_package)
                                                ...
                                                @else
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-12 mb-3">
                                                            ...
                                                            @elseif ($paymentConfiguration && strtolower($paymentConfiguration->payment_method) == 'ccavenue' && $paymentConfiguration->status == 1 && $package->type == 0)
                                                                <form action="{{ route('subscriptions.store') }}" method="POST">
                                                                    @csrf
                                                                    <input type="hidden" name="payment_method" value="ccavenue">
                                                                    <input type="hidden" name="package_id" value="{{ $package->id }}">
                                                                    <input type="hidden" name="type" value="package">
                                                                    <input type="hidden" name="package_type" value="immediate">
                                                                    <button class="btn btn-theme w-100">{{ __('update_current_plan') }}</button>
                                                                </form>
                                                            @else
                                                                <a href="#"
                                            ...
                                            @else
                                                ...
                                                @elseif ($paymentConfiguration && $paymentConfiguration->payment_method == 'Paystack' && $paymentConfiguration->status == 1)
                                                ...
                                                @elseif ($paymentConfiguration && strtolower($paymentConfiguration->payment_method) == 'ccavenue' && $paymentConfiguration->status == 1 && $package->type == 0)
                                                    <form action="{{ route('subscriptions.store') }}" method="POST">
                                                        ...
                                                        <input type="hidden" name="type" value="package">
                                                        <input type="hidden" name="package_type" value="new">
                                                        <button class="btn btn-theme w-100">{{ __('get_start') }}</button>
                                                    </form>
                                                @else
                                                    <div class="wrapper">
                                                        <a href="#"
