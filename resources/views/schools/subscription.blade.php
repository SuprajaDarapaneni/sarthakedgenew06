        ...
        <div class="row">
                ...
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0 font-weight-bold" style="font-size: 1.5rem; color: #333;">{{ $data['registration'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0 font-weight-bold" style="font-size: 1.5rem; color: #333;">{{ $data['active'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <p class="text-muted mb-2">{{ __('expiring_soon') }}</p>
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0 font-weight-bold" style="font-size: 1.5rem; color: #333;">{{ $data['expiring_soon'] }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        <div class="absolute left top bottom h-100 v-strock-2 bg-success"></div>
                        <p class="text-muted mb-2">{{ __('total_revenue') }}</p>
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0 font-weight-bold" style="font-size: 1.5rem; color: #333;">{{ $settings['currency_symbol'] }}{{ number_format($data['total_revenue'], 2) }}</h3>
                        </div>
                    </div>
                </div>
            </div>
