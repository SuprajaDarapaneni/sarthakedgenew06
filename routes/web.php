...
// Landing Pages
Route::get('refund-policy', [Controller::class, 'refundPolicyPage'])->name('refund-policy');
Route::get('privacy-policy', [Controller::class, 'privacyPolicyPage'])->name('privacy-policy');
Route::get('pricing', [Controller::class, 'pricingPage'])->name('pricing');
...
Route::group(['middleware' => ['Role', 'checkSchoolStatus', 'status', 'SwitchDatabase', 'verifiedEmail', 'CheckForMaintenanceMode', '2fa', 'wizardSettings']], static function () {
    ...
    Route::group(['middleware' => 'language'], static function () {
        ...
        Route::group(['prefix' => 'package'], static function () {
            Route::get('status/{id}', [PackageController::class, 'status'])->name('package.status');
        ...
        Route::post('features/store', [PackageController::class, 'feature_store'])->name('features.store');
        Route::put('features/update/{id}', [PackageController::class, 'feature_update'])->name('features.update');
        Route::put('features/status/{id}', [PackageController::class, 'feature_status'])->name('features.status');
        Route::delete('features/delete/{id}', [PackageController::class, 'feature_destroy'])->name('features.destroy');
        ...
        Route::group(['prefix' => 'elective-subject'], static function () {
            ...
            Route::get('/get-sections-by-class/{class_id}', [AssignElectiveSubjectController::class, 'getSectionsByClass'])->name('assign.elective.subject.get-sections');
            Route::get('/get-electives-by-class/{class_id}', [AssignElectiveSubjectController::class, 'getElectivesByClass'])->name('assign.elective.subject.get-electives');
        });
        ...
        Route::group(['prefix' => 'timetable'], static function () {
            ...
            Route::post('/copy', [TimetableController::class, 'copy'])->name('timetable.copy');
        ...
        Route::group(['prefix' => 'attendance'], static function () {
            ...
            Route::get('get-attendance-stats', [AttendanceController::class, 'getStats'])->name('attendance.get-stats');
            Route::get('get-attendance-analytics', [AttendanceController::class, 'getAnalytics'])->name('attendance.get-analytics');
        });
        ...
        Route::group(['prefix' => 'staff-attendance'], static function () {
            ...
            Route::get('get-stats', [StaffAttendanceController::class, 'getStats'])->name('staff-attendance.get-stats');
            Route::get('get-analytics', [StaffAttendanceController::class, 'getAnalytics'])->name('staff-attendance.get-analytics');
        });
